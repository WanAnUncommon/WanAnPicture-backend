...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (spaceUserId != null) {
            ...
            if (spaceUser == null) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "未找到空间用户信息");
            }
        ...
        if (spaceId == null) {
            ...
            Picture picture = pictureService.lambdaQuery()
                    ...
                    .one();
            if (picture == null) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "未找到图片信息");
            }
        ...
        if (space == null) {
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "未找到空间信息");
        }
        // 根据 Space 类型判断权限
